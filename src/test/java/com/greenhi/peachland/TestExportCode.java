...
public class TestExportCode {
    ...
    public TestExportCode() {
    }

    public TestExportCode(String outputPath) {
    ...
    public static void main(String[] args) {
        ...
        /*输入文件夹路径*/
        String inpath = "D:\\ideaProjects\\peachland-backend\\src\\main\\java\\com\\greenhi\\peachland";
        /*输出文件的路径*/
        String outpathString = "C:\\Users\\lenovo\\Desktop\\output.java";
        new TestExportCode(outpathString).showAllSubFile(inpath);
